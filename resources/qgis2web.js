...
map.getView().fit([518868.484083, 947216.384109, 521591.230671, 948865.756165], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Facility Mapping Of University of Ilorin</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_BuildingFacilities_2,
    colName: 'BUILDING',
    zoom: 10,
    collapsed: true,
    map: map,
